...
/client/verb/adminhelp(msg as text)
	...
	if(admin_number_present <= 0)
		adminmsg2adminirc(src, null, "[rhtml_decode(original_msg)] - !![admin_number_afk ? "All admins AFK ([admin_number_afk])" : "No admins online"]!!")
	else
		adminmsg2adminirc(src, null, "[rhtml_decode(original_msg)]")
